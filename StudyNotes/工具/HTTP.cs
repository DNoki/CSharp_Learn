...
public static class HTTP
{
    ...
    /// <returns></returns>
    public static async Task<bool> StreamToFile(Task<Stream> streamTask, string filePath, long speed = 1048576)
    {
    ...
    /// <returns></returns>
    public static async Task<bool> StreamToFile(Stream stream, string filePath, long speed = 1048576)
    {
        var task = new Task<bool>(() =>
        {
            try
    ...
    /// <returns></returns>
    public static async Task<Stream> GET(string url, Dictionary<string, string> headers = null, int overTime = -1, WebProxy proxy = null)
    {
    ...
    /// <param name="proxy">代理</param>
    /// <returns></returns>
    public static async Task<string> GETtoString(string url, Dictionary<string, string> headers = null, int overTime = -1, WebProxy proxy = null, Encoding encoding = null)
    {
    ...
    /// <returns></returns>
    public static async Task<Stream> POST(string url, Dictionary<string, string> headers, string data, string contentType, int overTime = -1, WebProxy proxy = null)
    {
        var request = WebRequest.Create(url) as HttpWebRequest;
        request.Method = "POST";
    ...
    /// <returns></returns>
    public static async Task<string> POSTtoString(string url, Dictionary<string, string> headers, string data, string contentType, int overTime = -1, WebProxy proxy = null, Encoding encoding = null)
    {
