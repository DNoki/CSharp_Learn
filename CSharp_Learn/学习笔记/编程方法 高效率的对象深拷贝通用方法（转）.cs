...
public static class ObjectCopy
{
    ...
    //缓存对象复制的方法。  
    private static Dictionary<Type, Func<object, Dictionary<Identity, object>, object>> methods1 = new Dictionary<Type, Func<object, Dictionary<Identity, object>, object>>();
    private static Dictionary<Type, Action<object, Dictionary<Identity, object>, object>> methods2 = new Dictionary<Type, Action<object, Dictionary<Identity, object>, object>>();
    ...
    private static Func<object, Dictionary<Identity, object>, object> CreateCloneMethod1(Type type, Dictionary<Identity, object> objects)
    {
        Type tmptype;
    ...
    private static Action<object, Dictionary<Identity, object>, object> CreateCloneMethod2(Type type, Dictionary<Identity, object> objects)
    {
        Type tmptype;
        var fields = GetSettableFields(type);
    ...
    private static T CopyImpl<T>(T source, Dictionary<Identity, object> objects) where T : class
    {
        //为空则直接返回null  
        if (source == null)
            return null;
